...
<header class="site-header d-flex flex-column justify-content-center align-items-center">
    <div class="container d-flex align-items-center">
         <form action="<?= base_url('home/inputcourse') ?>" method="post" class="d-flex align-items-center">
        <input type="text" name="nama_course" class="editable-input" placeholder="Your Course Name" required>
        <button type="submit" class="button custom-btn">Save</button>
        </form>
    </div>
</header>
