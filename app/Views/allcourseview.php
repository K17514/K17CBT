...
<style type="text/css">
    .site-header {
  background-image: url(/images/templatemo-wave-header.jpg), linear-gradient(#a534d2, #FFFFFF);
...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        <a class="navbar-brand me-lg-5 me-0" href="<?= base_url('home/index'); ?>">
            <img src="<?= base_url('images/chibitee-logo.png'); ?>" class="logo-image img-fluid" alt="Logo" loading="lazy">
...
<section class="latest-podcast-section py-3 pb-0" id="section_2">
    ...
    <?php if (!empty($courseToShow)): ?>
                ...
                <div class="custom-block d-flex flex-column">
                    <div>
                        <h5 class="mb-2 text-uppercase d-flex align-items-center">
                            ...
                            <a href="<?= base_url('home/editcourse/'.$course->id_course)?>" class="btn btn-sm btn-primary"><i class="bi bi-question-circle-fill"></i></a>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <li class="list-group-item text-center mb-5">No courses found.</li>
    <?php endif; ?>
</ul>
